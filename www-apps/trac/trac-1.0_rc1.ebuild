...
SRC_URI="http://download.edgewall.org/trac/${MY_P}.tar.gz"
...
RDEPEND="
	...
	sqlite? (
		>=dev-db/sqlite-3.3.4
		|| ( dev-lang/python:2.7[sqlite] dev-lang/python:2.6[sqlite] dev-lang/python:2.5[sqlite] >=dev-python/pysqlite-2.5.5 )
	)
