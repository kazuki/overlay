...
PATCHES=(
	...
	"${FILESDIR}/${PN}-5.7.0-replace-optional.patch"
	"${FILESDIR}/${PN}-5.7.0-fix-lld-elf-link.patch"
	"${FILESDIR}/${PN}-5.7.0-add-string-extras.patch"
	"${FILESDIR}/${PN}-5.7.0-update-getdesc.patch"
	"${FILESDIR}/${PN}-5.7.0-api-evolution-for-errorhandler.patch"
)
